...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"classes/movie_data.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  MovieData.prototype.getData = function (title) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , fetch('http://www.omdbapi.com/?apikey=4d83a963&t=' + title)];
...
var movie_data_1 = require("./classes/movie_data");
...
function (_super) {
  ...
  Movie.prototype.movieTitle = function (title) {
    this.getData(title).then(function (data) {
      // console.log(data);
...
// };
},{"./classes/movie_data":"classes/movie_data.ts"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
